(function ($) {
    ...
    // Credit to Geoff Graham for Bar Chart function

    function moveProgressBar() {
        console.log("moveProgressBar");
        var e = $(".progress-wrap").data("progress-percent") / 100,
            t = $(".progress-wrap").width(),
            n = e * t,
            i = 1500;
    ...
    function removeEvents() {
        document.body.removeEventListener("click", sendInteractionEvent), window.removeEventListener("scroll", sendInteractionEvent)
    }

    function sendInteractionEvent() {
        ga("send", "event", "Page Interaction"), removeEvents()
    }
    $(document).ready(function() {
            ...
            $(".chart .blue").mouseenter(function() {
                $(this).animate({
                    height: "35%"
                }, 800)
            }), $(".chart .blue").mouseleave(function() {
                $(this).animate({
                    height: "90%"
                }, 800)
            }), $(".chart .navy").mouseenter(function() {
                $(this).animate({
                    height: "35%"
                }, 800)
            }), $(".chart .navy").mouseleave(function() {
                $(this).animate({
                    height: "75%"
                }, 800)
            }), $(".chart .darkgreen").mouseenter(function() {
                $(this).animate({
                    height: "35%"
                }, 800)
            ...
            }), $(".chart .purple").mouseleave(function() {
                $(this).animate({
                    height: "60%"
                }, 800)
            }),
            ...
            $(".content").fitVids()
        }), document.body.addEventListener("click", sendInteractionEvent), window.addEventListener("scroll", sendInteractionEvent),
        function(e) {
